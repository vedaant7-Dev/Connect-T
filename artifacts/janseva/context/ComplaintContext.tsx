  ...
  return [
    {
      ...
      description: "Large pothole near Dadar station causing accidents",
      category: "roads",
      location: "Near Dadar Station, Dadar West",
      ward: "Ward 14 — Dadar",
      status: "in_progress",
    ...
    },
    {
      ...
      category: "water",
      location: "Building 12, Dharavi",
      ward: "Ward 16 — Dharavi",
      status: "resolved",
      ...
      timeline: [
        ...
        { status: "assigned", timestamp: new Date(now - 6 * 24 * 60 * 60 * 1000).toISOString(), note: "Assigned to BMC water dept", updatedBy: "Admin" },
        { status: "in_progress", timestamp: new Date(now - 5 * 24 * 60 * 60 * 1000).toISOString(), note: "Pipeline repair started", updatedBy: "BMC Team" },
        { status: "resolved", timestamp: new Date(now - 4 * 24 * 60 * 60 * 1000).toISOString(), note: "Water supply restored", updatedBy: "BMC Team" },
      ],
