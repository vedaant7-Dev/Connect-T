...
const SEED_POSTS: FeedPost[] = [
  {
    id: "POST001",
    authorName: "BMC Mumbai",
    authorRole: "Head Admin",
    avatarColor: "#1E40AF",
    type: "announcement",
    content: "🚨 Important: Water supply will be suspended in Dadar, Matunga & Wadala on Sunday 6AM-2PM for pipe maintenance. Please store water in advance.",
    likes: [],
    commentsCount: 12,
  ...
  },
  {
    ...
    avatarColor: "#059669",
    type: "update",
    content: "✅ Update: The pothole near Dadar station has been repaired. Road stretching 200m has been resurfaced. Thank you for your patience.",
    likes: [],
    commentsCount: 5,
  ...
  },
  {
    ...
    avatarColor: "#7C3AED",
    type: "general",
    content: "The new streetlights on Gokhale Road are excellent! Finally feel safe walking at night. Great work BMC 👏",
    likes: [],
    commentsCount: 3,
  ...
  },
  {
    ...
    avatarColor: "#D97706",
    type: "general",
    content: "Garbage has not been collected from our lane for 3 days. Area near Dharavi Market is smelling badly. Please take action 🙏",
    likes: [],
    commentsCount: 7,
