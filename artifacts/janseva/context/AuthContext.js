...
function AuthProvider(_a) {
    ...
    var loginWithPhone = function (mobile) { return __awaiter(_this, void 0, void 0, function () {
        var normalizedMobile, users, existingUser, directoryEntry_1, refreshed, idx, directoryEntry, colorIndex, nagarsevakUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    normalizedMobile = mobile.trim().replace(/\D/g, "");
                    return [4 /*yield*/, getAllUsers()];
                case 1:
                    users = _a.sent();
                    existingUser = users.find(function (u) { return u.mobile === normalizedMobile; });
                    if (!existingUser) return [3 /*break*/, 7];
                    if (!(existingUser.role === "nagarsevak" && existingUser.nagarsevakId)) return [3 /*break*/, 5];
                    directoryEntry_1 = (0, nagarsevaks_1.findNagarsevakById)(existingUser.nagarsevakId);
                    if (!directoryEntry_1) return [3 /*break*/, 5];
                    refreshed = __assign(__assign({}, existingUser), { name: directoryEntry_1.name, ward: directoryEntry_1.ward });
                    idx = users.findIndex(function (u) { return u.id === existingUser.id; });
                ...
                case 5: return [4 /*yield*/, login(existingUser)];
                case 6:
                    _a.sent();
                    return [2 /*return*/, existingUser];
                case 7:
                    directoryEntry = (0, nagarsevaks_1.findNagarsevakByMobile)(normalizedMobile);
                    if (!directoryEntry) return [3 /*break*/, 10];
                    colorIndex = Math.floor(Math.random() * AVATAR_COLORS.length);
                    nagarsevakUser = {
                        id: "U" + Date.now(),
                ...
                case 8:
                    _a.sent();
                    return [4 /*yield*/, login(nagarsevakUser)];
                case 9:
                    _a.sent();
                    return [2 /*return*/, nagarsevakUser];
