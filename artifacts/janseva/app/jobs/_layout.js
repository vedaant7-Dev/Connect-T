      ...
      <JobsContext_1.JobsProvider>
        <JobsAuthGate>
          <expo_router_1.Stack screenOptions={{ headerShown: false }}>
            ...
            <expo_router_1.Stack.Screen name="detail/[jobId]" options={{ animation: "slide_from_right" }}/>
            <expo_router_1.Stack.Screen name="chat/[employerId]" options={{ animation: "slide_from_right" }}/>
          </expo_router_1.Stack>
        </JobsAuthGate>
      </JobsContext_1.JobsProvider>
