      ...
      {step === "splash" && (<>
          <react_native_1.View style={styles.centre}>
            ...
            <react_native_1.View style={styles.taglineWrap}>
              <react_native_1.Text style={styles.taglineEn}>Civic Services Platform</react_native_1.Text>
              <react_native_1.Text style={styles.taglineHi}>सबका साथ, सबका विकास</react_native_1.Text>
            </react_native_1.View>
            <react_native_1.Text style={styles.poweredBy}>Powered by Connect T</react_native_1.Text>
          </react_native_1.View>
