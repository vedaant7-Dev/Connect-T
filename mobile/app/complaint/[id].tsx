    ...
    <Animated.View style={[styles.root, { opacity: fadeAnim }]}>
      ...
      <ScrollView
        ...
        contentContainerStyle={[
          styles.content,
          { paddingBottom: Math.max(insets.bottom, 8) + 40 },
        ]}
      ...
      >
          ...
          <View style={styles.complainantCard}>
            ...
            <View style={styles.complainantHeader}>
              <View style={styles.complainantAvatar}>
                <Text style={styles.complainantAvatarText}>
              ...
              {complaint.userMobile ? (
                <View style={styles.complainantRow}>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.complainantValue}>
                      +91 {complaint.userMobile}
                    </Text>
                  </View>
                </View>
              ) : null}
        ...
        <View style={styles.detailCard}>
          ...
          <View style={styles.detailRow}>
            ...
            <View>
              ...
              <Text style={styles.detailValue}>
                {t(categoryLabelKeys[complaint.category] || "other")}
              </Text>
            </View>
          </View>
          ...
          <View>
            ...
            <Text
              style={[styles.detailValue, { marginTop: 6, lineHeight: 20 }]}
            >
          ...
          {complaint.assignedTo && (
            <>
              ...
              <View style={styles.detailRow}>
                <View
                  style={[styles.catIconWrap, { backgroundColor: "#FFEDD5" }]}
                >
                ...
                <View key={idx} style={styles.timelineEntry}>
                  ...
                  <View style={styles.timelineRight}>
                    <View style={styles.tlHeader}>
                      <Text style={[styles.tlStatus, { color: eSt.color }]}>
                        {t(statusLabelKeys[entry.status])}
                      </Text>
                    ...
                    {entry.note ? (
                      <Text style={styles.tlNote}>{entry.note}</Text>
                    ) : null}
