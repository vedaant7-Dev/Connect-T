...
var STORAGE_KEY = "connectt_jobs_user";
...
function JobsAuthProvider(_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, async_storage_1.default.setItem(STORAGE_KEY, JSON.stringify(user))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, async_storage_1.default.removeItem(STORAGE_KEY)];
                case 3:
                    _a.sent();
                    _a.label = 4;
    ...
    var registerJobs = function (data) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, save(__assign(__assign({}, data), { id: generateId(), createdAt: new Date().toISOString() }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return (<JobsAuthContext.Provider value={{ jobsUser: jobsUser, loading: loading, registerJobs: registerJobs, loginJobs: loginJobs, logoutJobs: logoutJobs, updateJobsUser: updateJobsUser }}>
      {children}
