...
var logoImage = require("@/assets/images/logo_transparent.png");
function RootLayout() {
    var _this = this;
        ...
        var preload = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, expo_asset_1.Asset.loadAsync([logoImage])];
                    case 1:
                        _b.sent();
                        resolved = expo_asset_1.Asset.fromModule(logoImage);
                        if (!resolved.uri) return [3 /*break*/, 3];
                        return [4 /*yield*/, react_native_1.Image.prefetch(resolved.uri)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
