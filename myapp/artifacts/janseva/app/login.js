...
function LoginScreen() {
    ...
    var _a = (0, AuthContext_1.useAuth)(), register = _a.register, loginWithPhone = _a.loginWithPhone, loginWithNagarsevakId = _a.loginWithNagarsevakId;
    ...
    var _t = (0, react_1.useState)(""), loginId = _t[0], setLoginId = _t[1];
    ...
    var _u = (0, react_1.useState)(["", "", "", ""]), otpDigits = _u[0], setOtpDigits = _u[1];
    ...
    var handleLoginOtp = function () { return __awaiter(_this, void 0, void 0, function () {
        var otp, phone, id, nagarsevak, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    otp = otpDigits.join("");
                ...
                case 1:
                    ...
                    id = loginId.trim().toUpperCase();
                    if (!id) return [3 /*break*/, 3];
                    return [4 /*yield*/, loginWithNagarsevakId(phone, id)];
                case 2:
                    nagarsevak = _a.sent();
                    if (nagarsevak) {
                        expo_router_1.router.replace("/(tabs)/admin");
                        return [2 /*return*/];
                    }
                    else {
                    ...
                    _a.label = 3;
                case 3: return [4 /*yield*/, loginWithPhone(phone)];
                case 4:
                    user = _a.sent();
                    if (user) {
    ...
    var renderOtpInput = function () { return (<react_native_1.View style={s.otpSection}>
      ...
      <react_native_1.View style={s.otpRow}>
        {otpDigits.map(function (digit, i) { return (<react_native_1.TextInput key={i} ref={otpRefs[i]} style={[s.otpBox, digit ? s.otpBoxFilled : null]} value={digit} onChangeText={function (v) { return setOtpDigit(i, v.slice(-1), otpRefs); }} keyboardType="number-pad" maxLength={1} textAlign="center" onKeyPress={function (_a) {
                var _b, _c;
    ...
    var renderRegisterForm = function () { return (<react_native_1.View style={s.formCard}>
      ...
      <react_native_1.TextInput style={s.input} placeholder={t("enterFullName")} placeholderTextColor="#94A3B8" value={regName} onChangeText={setRegName} autoCapitalize="words"/>

      <react_native_1.Text style={s.fieldLabel}>{t("age")}</react_native_1.Text>
      <react_native_1.TextInput style={s.input} placeholder={t("enterAge")} placeholderTextColor="#94A3B8" keyboardType="number-pad" maxLength={3} value={regAge} onChangeText={setRegAge}/>

      <react_native_1.Text style={s.fieldLabel}>
        {t("email")} <react_native_1.Text style={s.optional}>({t("optional")})</react_native_1.Text>
      </react_native_1.Text>
      <react_native_1.TextInput style={s.input} placeholder="yourname@email.com" placeholderTextColor="#94A3B8" keyboardType="email-address" autoCapitalize="none" value={regEmail} onChangeText={setRegEmail}/>

      <react_native_1.Text style={s.fieldLabel}>
        {t("currentAddress")} <react_native_1.Text style={s.required}>*</react_native_1.Text>
      </react_native_1.Text>
      <react_native_1.TextInput style={[s.input, { minHeight: 60, textAlignVertical: "top" }]} placeholder={t("enterAddress")} placeholderTextColor="#94A3B8" multiline numberOfLines={2} value={regAddress} onChangeText={setRegAddress}/>
      ...
      <react_native_1.View style={s.phoneRow}>
        ...
        <react_native_1.TextInput style={[s.input, s.phoneInput]} placeholder="10-digit mobile number" placeholderTextColor="#94A3B8" keyboardType="phone-pad" maxLength={10} value={regPhone} onChangeText={setRegPhone}/>
      </react_native_1.View>
    ...
    var renderLoginForm = function () { return (<react_native_1.View style={s.formCard}>
      ...
      <react_native_1.View style={s.phoneRow}>
        ...
        <react_native_1.TextInput style={[s.input, s.phoneInput]} placeholder={t("enterPhoneNumber")} placeholderTextColor="#94A3B8" keyboardType="phone-pad" maxLength={10} value={loginPhone} onChangeText={setLoginPhone}/>
      </react_native_1.View>

      <react_native_1.Text style={s.fieldLabel}>
        {t("nagarsevakIdLabel")} <react_native_1.Text style={s.optional}>({t("optional")})</react_native_1.Text>
      </react_native_1.Text>
      <react_native_1.TextInput style={s.input} placeholder={t("nagarsevakIdPlaceholder")} placeholderTextColor="#94A3B8" autoCapitalize="characters" value={loginId} onChangeText={setLoginId}/>
      <react_native_1.Text style={s.helperText}>{t("nagarsevakIdHelp")}</react_native_1.Text>
    ...
    return (<expo_linear_gradient_1.LinearGradient colors={["#9A3412", "#C2410C", "#EA580C", "#F97316", "#FB923C"]} locations={[0, 0.2, 0.45, 0.75, 1]} style={[s.root, { paddingTop: topPad, overflow: "hidden" }]}>
      ...
      <react_native_1.KeyboardAvoidingView behavior={react_native_1.Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1 }}>
        <react_native_1.ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
