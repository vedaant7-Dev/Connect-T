...
function JobsProfileScreen() {
    ...
    var _g = (0, JobsAuthContext_1.useJobsAuth)(), jobsUser = _g.jobsUser, logoutJobs = _g.logoutJobs, updateJobsUser = _g.updateJobsUser;
    var _h = (0, JobsContext_1.useJobs)(), getJobsByEmployer = _h.getJobsByEmployer, jobs = _h.jobs;
    var router = (0, expo_router_1.useRouter)();
    var _j = (0, react_1.useState)(false), showLogout = _j[0], setShowLogout = _j[1];
    var _k = (0, react_1.useState)(false), editing = _k[0], setEditing = _k[1];
    // Seeker fields
    var _l = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.name) || ""), eName = _l[0], setEName = _l[1];
    var _m = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.email) || ""), eEmail = _m[0], setEEmail = _m[1];
    var _o = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.age) || ""), eAge = _o[0], setEAge = _o[1];
    var _p = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.qualification) || ""), eQual = _p[0], setEQual = _p[1];
    var _q = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.skills) || ""), eSkills = _q[0], setESkills = _q[1];
    var _r = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.about) || ""), eAbout = _r[0], setEAbout = _r[1];
    var _s = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.currentStatus) || ""), eStatus = _s[0], setEStatus = _s[1];
    var _t = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.currentCompany) || ""), eCurrentCompany = _t[0], setECurrentCompany = _t[1];
    var _u = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.currentRole) || ""), eCurrentRole = _u[0], setECurrentRole = _u[1];
    var _v = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.experience) || ""), eExperience = _v[0], setEExperience = _v[1];
    var _w = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.previousCompany) || ""), ePrevCompany = _w[0], setEPrevCompany = _w[1];
    var _x = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.previousRole) || ""), ePrevRole = _x[0], setEPrevRole = _x[1];
    var _y = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.collegeName) || ""), eCollegeName = _y[0], setECollegeName = _y[1];
    var _z = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.fieldOfStudy) || ""), eFieldOfStudy = _z[0], setEFieldOfStudy = _z[1];
    var _0 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.location) || ""), eLocation = _0[0], setELocation = _0[1];
    var _1 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.languages) || ""), eLanguages = _1[0], setELanguages = _1[1];
    // Employer fields
    var _2 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.company) || ""), eCompany = _2[0], setECompany = _2[1];
    var _3 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.gstNo) || ""), eGst = _3[0], setEGst = _3[1];
    var _4 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.companyType) || ""), eCompanyType = _4[0], setECompanyType = _4[1];
    var _5 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.companySize) || ""), eCompanySize = _5[0], setECompanySize = _5[1];
    var _6 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.industry) || ""), eIndustry = _6[0], setEIndustry = _6[1];
    var _7 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.website) || ""), eWebsite = _7[0], setEWebsite = _7[1];
    var _8 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.companyDescription) || ""), eCompanyDesc = _8[0], setECompanyDesc = _8[1];
    var _9 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.address) || ""), eAddress = _9[0], setEAddress = _9[1];
    var _10 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.pincode) || ""), ePincode = _10[0], setEPincode = _10[1];
    var _11 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.whatsapp) || ""), eWhatsapp = _11[0], setEWhatsapp = _11[1];
    var _12 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.yearEstablished) || ""), eYearEst = _12[0], setEYearEst = _12[1];
    var _13 = (0, react_1.useState)((jobsUser === null || jobsUser === void 0 ? void 0 : jobsUser.contactPerson) || ""), eContactPerson = _13[0], setEContactPerson = _13[1];
    if (!jobsUser)
        return null;
    ...
    return (<react_native_1.View style={cs.root}>
      <expo_linear_gradient_1.LinearGradient colors={["#C2410C", "#EA580C", "#F97316", "#FB923C"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={[cs.header, { paddingTop: topPad + 12 }]}>
        <react_native_1.View style={cs.headerRow}>
          ...
          <react_native_1.TouchableOpacity onPress={openEdit} style={cs.editBtn}>
        ...
        <react_native_1.View style={cs.statsRow}>
          {isEmployer ? (<>
      ...
      <react_native_1.ScrollView style={{ flex: 1 }} contentContainerStyle={[cs.content, { paddingBottom: Math.max(insets.bottom, 8) + 90 }]} showsVerticalScrollIndicator={false}>
        ...
        {isEmployer && (<>
            {/* About company */}
            {jobsUser.companyDescription ? (<SectionCard title="About Company" icon="info">
                <react_native_1.Text style={cs.aboutText}>{jobsUser.companyDescription}</react_native_1.Text>
              </SectionCard>) : (<react_native_1.TouchableOpacity onPress={openEdit} activeOpacity={0.8}>
            ...
            <SectionCard title="Company Overview" icon="briefcase">
              <react_native_1.View style={cs.overviewGrid}>
                {jobsUser.companyType && (<react_native_1.View style={cs.overviewChip}>
                    <vector_icons_1.Feather name="tag" size={12} color="#EA580C"/>
                    <react_native_1.Text style={cs.overviewChipText}>{jobsUser.companyType}</react_native_1.Text>
                  </react_native_1.View>)}
                {jobsUser.companySize && (<react_native_1.View style={cs.overviewChip}>
                    <vector_icons_1.Feather name="users" size={12} color="#1D4ED8"/>
                    <react_native_1.Text style={[cs.overviewChipText, { color: "#1D4ED8" }]}>{jobsUser.companySize}</react_native_1.Text>
                  </react_native_1.View>)}
                {jobsUser.industry && (<react_native_1.View style={cs.overviewChip}>
                    <vector_icons_1.Feather name="layers" size={12} color="#7C3AED"/>
                    <react_native_1.Text style={[cs.overviewChipText, { color: "#7C3AED" }]}>{jobsUser.industry}</react_native_1.Text>
                  </react_native_1.View>)}
                {jobsUser.yearEstablished && (<react_native_1.View style={cs.overviewChip}>
                    <vector_icons_1.Feather name="calendar" size={12} color="#059669"/>
                    <react_native_1.Text style={[cs.overviewChipText, { color: "#059669" }]}>Est. {jobsUser.yearEstablished}</react_native_1.Text>
                  </react_native_1.View>)}
              </react_native_1.View>
              {(!jobsUser.companyType && !jobsUser.companySize && !jobsUser.industry) && (<react_native_1.TouchableOpacity onPress={openEdit} style={cs.addInfoBtn}>
                  <react_native_1.Text style={cs.addInfoText}>+ Add company details</react_native_1.Text>
                </react_native_1.TouchableOpacity>)}
      ...
      <react_native_1.Modal visible={editing} animationType="slide" onRequestClose={function () { return setEditing(false); }}>
        <react_native_1.View style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
          <expo_linear_gradient_1.LinearGradient colors={["#C2410C", "#EA580C"]} style={[cs.editHeader, { paddingTop: (react_native_1.Platform.OS === "web" ? 44 : insets.top) + 12 }]}>
            ...
            <react_native_1.Text style={cs.editHeaderTitle}>Edit Profile</react_native_1.Text>
          ...
          <react_native_1.ScrollView contentContainerStyle={cs.editScroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
            ...
            {isEmployer ? (<>
                <react_native_1.Text style={cs.editSection}>Company Information</react_native_1.Text>
                ...
                <react_native_1.Text style={cs.editSection}>Contact & Address</react_native_1.Text>
                ...
                <react_native_1.Text style={cs.editSection}>Business Verification</react_native_1.Text>
                ...
                <react_native_1.Text style={cs.editSection}>Education</react_native_1.Text>
                <EditField label="Highest Qualification" value={eQual} onChange={setEQual} placeholder="e.g. 12th Pass, B.Com, ITI"/>

                <react_native_1.View style={cs.statusBanner}>
                  <expo_linear_gradient_1.LinearGradient colors={["#FFEDD5", "#FED7AA"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={cs.statusBannerGrad}>
                    <react_native_1.View style={cs.statusBannerIcon}><vector_icons_1.Feather name="activity" size={16} color="#EA580C"/></react_native_1.View>
                    <react_native_1.View style={{ flex: 1 }}>
                      <react_native_1.Text style={cs.statusBannerTitle}>Tell us where you stand</react_native_1.Text>
                      <react_native_1.Text style={cs.statusBannerSub}>Your status decides which fields you fill next.</react_native_1.Text>
                    </react_native_1.View>
                  </expo_linear_gradient_1.LinearGradient>
                </react_native_1.View>

                <SelectField label="Current Status" value={((_f = STATUS_OPTIONS.find(function (s) { return s.id === eStatus; })) === null || _f === void 0 ? void 0 : _f.label) || ""} options={STATUS_OPTIONS.map(function (s) { return s.label; })} onChange={function (label) {
                var found = STATUS_OPTIONS.find(function (s) { return s.label === label; });
                if (found)
                    setEStatus(found.id);
            }}/>

                {eStatus === "employed" && (<react_native_1.View style={cs.condBlock}>
                    <react_native_1.View style={[cs.condHeader, { backgroundColor: "#D1FAE5" }]}>
                      <vector_icons_1.Feather name="briefcase" size={14} color="#059669"/>
                      <react_native_1.Text style={[cs.condHeaderText, { color: "#059669" }]}>Your current job</react_native_1.Text>
                    </react_native_1.View>
                ...
                {eStatus === "unemployed" && (<react_native_1.View style={cs.condBlock}>
                    <react_native_1.View style={[cs.condHeader, { backgroundColor: "#FFEDD5" }]}>
                      <vector_icons_1.Feather name="search" size={14} color="#EA580C"/>
                      <react_native_1.Text style={[cs.condHeaderText, { color: "#EA580C" }]}>Your last job (optional)</react_native_1.Text>
                    </react_native_1.View>
                    <EditField label="Total Experience" value={eExperience} onChange={setEExperience} placeholder="e.g. 2 years"/>
                ...
                {eStatus === "student" && (<react_native_1.View style={cs.condBlock}>
                    <react_native_1.View style={[cs.condHeader, { backgroundColor: "#EDE9FE" }]}>
                      <vector_icons_1.Feather name="book-open" size={14} color="#7C3AED"/>
                      <react_native_1.Text style={[cs.condHeaderText, { color: "#7C3AED" }]}>Your studies</react_native_1.Text>
                    </react_native_1.View>
                ...
                {eStatus === "fresher" && (<react_native_1.View style={cs.condBlock}>
                    <react_native_1.View style={[cs.condHeader, { backgroundColor: "#DBEAFE" }]}>
                      <vector_icons_1.Feather name="star" size={14} color="#0369A1"/>
                      <react_native_1.Text style={[cs.condHeaderText, { color: "#0369A1" }]}>Just starting out — no experience needed</react_native_1.Text>
                    </react_native_1.View>
                  </react_native_1.View>)}

                <react_native_1.Text style={cs.editSection}>Skills & Career Objective</react_native_1.Text>
