...
function PostJobScreen() {
    ...
    var _b = (0, react_1.useState)("manufacturing"), category = _b[0], setCategory = _b[1];
    var _c = (0, react_1.useState)(""), customCategory = _c[0], setCustomCategory = _c[1];
    var _d = (0, react_1.useState)("full-time"), type = _d[0], setType = _d[1];
    var _e = (0, react_1.useState)(""), salary = _e[0], setSalary = _e[1];
    var _f = (0, react_1.useState)("Ambernath"), location = _f[0], setLocation = _f[1];
    var _g = (0, react_1.useState)("1"), openings = _g[0], setOpenings = _g[1];
    var _h = (0, react_1.useState)(""), description = _h[0], setDescription = _h[1];
    var _j = (0, react_1.useState)(""), requirements = _j[0], setRequirements = _j[1];
    var _k = (0, react_1.useState)(false), submitting = _k[0], setSubmitting = _k[1];
    var _l = (0, react_1.useState)(false), posted = _l[0], setPosted = _l[1];
    var _m = (0, react_1.useState)(""), postedTitle = _m[0], setPostedTitle = _m[1];
    ...
    return (<react_native_1.View style={styles.root}>
      ...
      <react_native_1.ScrollView style={{ flex: 1 }} contentContainerStyle={[styles.form, { paddingBottom: Math.max(insets.bottom, 8) + 80 }]} showsVerticalScrollIndicator={false}>
